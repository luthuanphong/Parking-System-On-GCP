...
# Configuration
ENDPOINT_URL = "https://parking-service-api-652635654773.asia-southeast1.run.app/api/users/login"  # Set your endpoint URL here
PAYLOAD = {
    "username": "user_",
    "password": "123456",
...
def main():
    ...
    for i in range(1, LOOP_COUNT + 1):
        ...
        clonedPayload['username'] = PAYLOAD['username'] + "{}".format(i)
        ...
        if response_data is not None:
            ...
            responses.append({
                response_data['username']: response_data['token']
            })
            print("✓ Success")
        else:
            print("✗ Failed")
